...
function ease_and_wizz_script(ui_reference) {
    ...
    var ew_determineFileName = function() {
        ...
        var fileToLoad =
            curveType + '-' + easingType + easeandwizzOrCurvaceous + '-' + keyframesToAffect + filenameSuffix;
        return fileToLoad;
    };
    ...
    var ew_setProps = function(expressionCode) {
        ...
        for (i = 0; i < selectedProperties.length; i += 1) {
            ...
            if (
                currentProperty.propertyValueType === PropertyValueType.SHAPE &&
                !ease_and_wizz.curvaceousCheckbox.value
            ) {
    ...
    var ew_createPalette = function(thisObj) {
        ...
        ease_and_wizz.easingList = easingGrp.add(
            'dropdownlist',
            LIST_DIMENSIONS,
            ease_and_wizz.easingTypesAry
        );
        ...
        ease_and_wizz.easingList.onChange = function() {
            if (ease_and_wizz.easingList.selection === null) {
                ...
                app.settings.saveSetting(
                    'easeandwizz',
                    ease_and_wizz.EASING_SETTINGS_KEY,
                    ease_and_wizz.easingList.selection.text
                );
            }
        };
        ...
        ease_and_wizz.typeList.onChange = function() {
            app.settings.saveSetting(
                'easeandwizz',
                ease_and_wizz.TYPE_SETTINGS_KEY,
                ease_and_wizz.typeList.selection.text
            );
        };
        ...
        if (
            app.settings.haveSetting('easeandwizz', ease_and_wizz.KEYS_SETTINGS_KEY) &&
            !ease_and_wizz.curvaceousCheckbox.value
        ) {
        ...
        ease_and_wizz.keysList.onChange = function() {
            app.settings.saveSetting(
                'easeandwizz',
                ease_and_wizz.KEYS_SETTINGS_KEY,
                ease_and_wizz.keysList.selection.text
            );
        };
        ...
        helpBtn.onClick = function() {
            alert(
                'Ease and Wizz v' + ease_and_wizz.VERSION + '\n' + ease_and_wizz.strHelpText,
                'Ease and Wizz'
            );
        };
    ...
    ease_and_wizz.easingTypesAry = [
        ...
        'Elastic',
        '-'
    ].concat(ease_and_wizz.multiLookup);

    // strings used in the interface
    ease_and_wizz.strHelpText =
        'Ease and Wizz is a set of expressions that give you more animation options, such as exponential, elastic, and bounce. Simply select a keyframe, choose the type of easing, and click "Apply". The relevant expression will be attached to that property.\n' +
        '\n' +
    ...
    ease_and_wizz.TOOLTIP_CURVACEOUS =
        'Turn this on if you’re easing a mask shape or shape path. Note that due to the way it works, Curvaceous automatically disables the “special” easing types, back, bounce, and elastic.';
    ease_and_wizz.TOOLTIP_KEYS =
        'When there are more than two keyframes, this affects whether it eases ALL of the keyframes (the default), the first and last two, or only the first two. Other keyframes will behave as usual.';
    ease_and_wizz.TOOLTIP_EASING =
        "Choose the type of easing here. They're arranged from most dramatic (expo) to least dramatic (sine), followed by “special effects” (back, bounce, elastic).\n\nFinally, the multi-easing types: one easing type, followed by the other. They apply to the first two and the last two keyframes of a property.";
    ease_and_wizz.TOOLTIP_TYPE = 'Whether the values ease in, out, or both.';
    ease_and_wizz.CURVACEOUS_ERROR_TXT =
        'It looks like you have a Mask Path selected. To apply Ease and Wizz to a Mask Path, select the ‘Curvaceous’ checkbox and try again.';
